//
//  RidesAvailableViewController.m
//  iShareRyde
//
...
#import "RidesAvailableViewController.h"
...
@interface RidesAvailableViewController () <GlobalMethodsAsyncRequestProtocol, UIAlertViewDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation RidesAvailableViewController

- (NSString *)TAG {
    return @"RidesAvailableViewController";
}
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    /*if ([self nidFromNotification] && [[self nidFromNotification] length] > 0) {
        ...
        if ([[NSUserDefaults standardUserDefaults] boolForKey:KEY_USER_DEFAULT_CHECK_OPEN_RIDES]) {
        [self fetchPools];
    }
